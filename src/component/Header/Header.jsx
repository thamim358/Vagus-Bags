...
import LOGO from "../img/bag logo.jpeg";
    ...
    <>
      ...
      >
        <div className=" sm:mx-auto md:mx-10 lg:mx-20 flex items-center justify-between  ">
          <div className="text-[#ff5c2a] font-black font-mono text-3xl ml-4 p-3">
            {/* SUMADULA */}
            <img src={LOGO} alt="wdwd" className="h-16" />
          </div>
          <nav>
            ...
            >
              <li>
                <Link
                  className="text-black  hover:text-[#ff5c2a] font-semibold font-sans cursor-pointer"
                  activeClass="active"
                  to="home"
                  spy={true}
                  smooth={true}
      ...
      <div className={`overlay-menu ${isMobileMenuOpen ? "open" : "hidden"}`}>
        ...
        <img src={LOGO} alt="wdwd" className="h-20" />
          <button
            onClick={toggleMobileMenu}
            className="text-black hover:text-[#ff5c2a]  focus:outline-none"
          >
            <svg
        ...
        <ul className="p-10">
          <li className="">
            <Link
              className="text-black  hover:text-[#ff5c2a] text-xl font-bold font-sans cursor-pointer"
              activeClass="active"
              to="home"
              spy={true}
              smooth={true}
